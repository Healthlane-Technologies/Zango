...
- **Navigate to the Tasks Menu**:
   Access the Tasks menu in the App Panel of your Zango application.
...
By following these steps, you can effectively schedule async tasks within your Zango application, enabling automated execution of tasks at specified intervals. This feature enhances the efficiency of your application by automating routine tasks and processes.
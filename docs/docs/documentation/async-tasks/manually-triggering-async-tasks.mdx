...
- **Import the Task Executor**: 
   Import the `zelthy_task_executor` function from the `zango.core.tasks` module. This function is responsible for executing the async task.

   ```python
   from zango.core.tasks import zelthy_task_executor
   ```

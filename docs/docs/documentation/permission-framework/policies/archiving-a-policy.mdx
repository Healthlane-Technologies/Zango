...
Archiving a policy is an essential task for maintaining a well-organized access control environment. Here's a step-by-step guide on how to archive a policy using the App Panel interface:

...
Creating policies is a pivotal step in configuring access control within the Zelthy platform. Here's a step-by-step guide on how to create a new policy using the z-Dynamic interface:

<center> <mark> Add screen recording here </mark> </center>

1. **Navigate to Policy Page:**
   Begin by accessing the "Policy" submenu within the "Permission Management" menu in z-Dynamic. This will direct you to the Policy page, providing an overview of all existing policies within your application through a tabular format.

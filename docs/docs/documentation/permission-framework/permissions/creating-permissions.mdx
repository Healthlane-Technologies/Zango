...
Permissions within the Zango platform play a pivotal role in regulating access to resources and functionalities within business applications. However, the creation of permissions follows a distinct approach to ensure consistency and control. Permissions are created automatically.

## Automatic Permission Creation

Creating permissions directly is not the typical process, with an exception for Custom type permission. Instead, relevant permissions are automatically generated as you create different components of your application, such as data models and views.
...
By adopting this approach, you establish a clear and organized system where permissions are intricately tied to resources, promoting transparency in access control and facilitating comprehensive audit trails for every interaction within your business applications.
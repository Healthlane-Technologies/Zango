...
Permissions within the ZCore platform play a pivotal role in regulating access to resources and functionalities within healthcare applications. However, the creation of permissions follows a distinct approach to ensure consistency and control. Permissions are created automatically (except for [Custom Permissions](./custom-permissions)).

...
After installing Zango, you can use the zango start-project command, provided by [zango CLI](../../getting-started/zango-cli) to initiate the creation of a new project. Replace "MyFirstProject" with your preferred project name.
```
...
Before running the runserver command, make sure your [redis](../../core/setting-up-zango-project/overview#2-redis-setup) and [celery worker](../../setting-up-zango-project/creating-zango-project#starting-the-celery-worker-and-celery-beat) are up and running

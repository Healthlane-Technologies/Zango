...
In the app view within z-Dynamic, you have the ability to update and configure various settings for your healthcare app. Here's how you can update the app settings:

#### 1. Access the App View:

Make sure you are in the app view by clicking on the app card in z-Dynamic, as described in the previous section.

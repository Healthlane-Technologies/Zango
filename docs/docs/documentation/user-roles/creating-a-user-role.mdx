...
To establish distinct access privileges and responsibilities for different users, you can create customized user roles within the ZCore platform. Follow these simple steps to create a new user role:

...
```
http://127.0.0.1:8000/admin/login/?next=/platform/
```
<center> <mark> Add login screen of App Panel here</mark> </center>
...
<center> <mark> Add App Panel's landing Page </mark> </center>
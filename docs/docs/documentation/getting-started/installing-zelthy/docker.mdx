...
When running Zelthy with Docker, ensure your system meets the following:

- **RAM:** At least 4 GB (2 GB may cause crashes)
- **CPU:** 2 cores recommended
- **Disk Space:** 5–10 GB free space

### Notes

- Low memory may cause Docker containers to stop unexpectedly (SIGKILL errors).
- Increase memory allocation in Docker Desktop or Rancher Desktop if needed.

...
| `install-package`| Install a package                            | `--tenant`: Tenant                                                                       |
| `list-packages` | Lists all the available Zango packages         | `--tenant`: Tenant                                                                       |
...
| `update-apps`   | Updates an existing app                        | `--app_name`: App Name(s)                                                                |

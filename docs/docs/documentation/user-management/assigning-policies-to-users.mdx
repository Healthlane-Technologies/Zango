...
Granting specific permissions to users through policies is a valuable feature in the User Management system of z-Dynamic. This capability enables administrators and developers to provide customized access and permissions at a user level, allowing for precise control based on individual needs. Here's a step-by-step guide on how to assign policies to users:

<center> <mark> Add screen recording here </mark> </center>

1. **Navigate to User Management Page:**
   Begin by clicking on the "User Management" menu in z-Dynamic. This action will take you to the User Management page.

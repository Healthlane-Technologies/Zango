...
Updating the user roles assigned to a user can be pivotal in aligning their access and permissions with their evolving responsibilities. In the z-Dynamic User Management system, you have the flexibility to modify user roles for users, allowing for refined access control. Here's a step-by-step guide on how to change user roles for a user:

<center> <mark> Add screen recording here </mark> </center>

1. **Navigate to User Management Page:**
   Begin by clicking on the "User Management" menu in z-Dynamic. This action will direct you to the User Management page.

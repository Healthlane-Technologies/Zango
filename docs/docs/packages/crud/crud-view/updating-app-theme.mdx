...
The Zango platform allows you to customize the user interface (UI) theme of your business app, including primary and secondary colors, fonts, call-to-action (CTA) styles, and more. This flexibility enables you to align your app's appearance with your organization's branding guidelines, ensuring consistency and a professional look. Here's how you can update the theme of your app:

#### 1. Access App Settings:

Ensure that you are within the app view by clicking on the app card in App Panel, as described in the previous sections.
...
As soon as you save the updated theme, you'll notice that all the UI components of your business app will begin to reflect the new color theme and styles, aligning with your organization's brand guidelines. This ensures that your app not only functions effectively but also provides a visually cohesive and branded experience for users.

By customizing the app theme, you can create a consistent and appealing look and feel for your business app, enhancing its usability and user experience.
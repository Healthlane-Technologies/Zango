...
[here](../../packages/crud/tables/overview).
...
The Workflow component, offered by the [Workflow Package](../../packages/workflow/overview), is an essential tool for managing and structuring 
...
of the [Crud Package](../../packages/crud/overview). We have to simply tell `BaseCrudView` about the Format to display the data in,

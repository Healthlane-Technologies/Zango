...
export default function WarningToast({ toastRef, title, description }) {
	return (
		<div
			className={`relative flex max-w-[247px] flex-col items-start gap-[12px] rounded-[4px] border border-[#FECF7F] bg-[#fef7ef] p-[16px] shadow-notification ${

...
export default function ErrorToast({ toastRef, title, description }) {
	return (
		<div
			className={`relative flex max-w-[247px] flex-col items-start gap-[12px] rounded-[4px] border border-[#AB1032] bg-[#ffefef] p-[16px] shadow-notification ${

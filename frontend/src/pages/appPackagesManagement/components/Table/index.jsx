...
export default function Table({ tableData }) {
	...
	const table = useReactTable({
		data: appPackagesManagementData.packages?.records ?? defaultData,
		columns,
		pageCount: appPackagesManagementData.packages?.total_pages ?? -1,
		state: {
			pagination,
		},
	...
	useEffect(() => {
		searchRef.current.value = appPackagesManagementTableData?.searchValue || '';
	}, []);

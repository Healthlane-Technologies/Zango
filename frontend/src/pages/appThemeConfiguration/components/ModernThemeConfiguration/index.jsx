		...
		<div className={`relative bg-white rounded-[12px] border p-[20px] transition-all hover:shadow-md ${
			...
			<div className="space-y-[12px] mb-[16px]">
				<div className="grid grid-cols-2 gap-[8px]">
					{theme.config?.colors && (
						<>
							<ColorPreview color={theme.config.colors.primary} label="Primary" />
							<ColorPreview color={theme.config.colors.gray} label="Gray" />
							<ColorPreview color={theme.config.colors.success} label="Success" />
							<ColorPreview color={theme.config.colors.warning} label="Warning" />
							<ColorPreview color={theme.config.colors.error} label="Error" />
							<ColorPreview color={theme.config.colors.info} label="Info" />
						</>
					)}
				</div>
			</div>

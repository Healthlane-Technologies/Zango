			...
			<div className="flex flex-col h-full bg-[#F8FAFC] overflow-hidden">
				...
				<div className="flex-1 px-[40px] py-[32px] bg-[#F8FAFC] overflow-y-auto">
					<div className="space-y-6">
							...
							<p className="mt-2 text-sm text-muted-foreground">{searchTerm || filters.is_active !== '' ? 'No users found' : 'No users yet'}</p>
							<button
								onClick={handleAddNewUser}
							...
							>
								...
								{searchTerm || filters.is_active !== '' ? 'Add User' : 'Create First User'}
							</button>
						</div>
					) : viewMode === 'card' ? (
						<UsersList

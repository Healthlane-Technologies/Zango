...
from zelthy_enterprise.apps.auditlog.conf import settings
from zelthy_enterprise.apps.auditlog.signals import accessed
...
class AuditlogModelRegistry:
    ...
    def _connect_signals(self, model):
        ...
        """
        from zelthy_enterprise.apps.auditlog.receivers import make_log_m2m_changes

...
* Restrict CORS to each tenant's own registered domains instead of reflecting any origin, keeping the static allow-list additive [(#613)](https://github.com/Healthlane-Technologies/Zango/pull/613)
* Reject `TRACE` requests and hide the nginx version banner in the deploy config [(#613)](https://github.com/Healthlane-Technologies/Zango/pull/613)
...
* Make audit log multi-tenant safe + non-blocking [(#590)](https://github.com/Healthlane-Technologies/Zango/pull/590)
...
* Fix AI migrations to resolve migration conflicts [(#580)](https://github.com/Healthlane-Technologies/Zango/pull/580)
* Drop unused policy seeding migration from `code_execution` — the three policies were never enforced at the view layer [(#578)](https://github.com/Healthlane-Technologies/Zango/pull/578)

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_a', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='loadtest_1.modela')),
            ],
        ),
        migrations.CreateModel(
            name='ModelC',
            fields=[
                ...
                ('model_b', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='loadtest_1.modelb')),
            ],
        ),
        migrations.CreateModel(
            name='AggBook',
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='loadtest_1.aggauthor')),
            ],
        ),
    ]

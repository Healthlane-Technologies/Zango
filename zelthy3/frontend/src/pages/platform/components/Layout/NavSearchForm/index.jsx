			...
			{(formik) => {
				return (
					...
					>
						...
						<div className="flex flex-col gap-4 rounded-[4px] bg-[#F0F3F4] md:flex-row">
							<div className="flex flex-col gap-[4px]">
								<div className="flex items-center gap-[12px] rounded-[4px] bg-[#F0F3F4] py-[6px] px-[12px]">
									...
									<input
										...
										className="w-full bg-transparent font-lato text-sm outline-0 ring-0 placeholder:text-[#6C747D] md:w-[604px]"

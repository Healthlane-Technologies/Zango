...
CORS_ORIGIN_WHITELIST = env("CORS_ORIGIN_WHITELIST") # Change according to domain configured
CSRF_TRUSTED_ORIGINS = env("CSRF_TRUSTED_ORIGINS") # Change according to domain configured

...
from zcore.apps.dynamic_models.fields import ZOneToOneField, ZForeignKey
from zcore.core.storage_utils import ZFileField
from zcore.core.utils import get_current_request
        ...
        fields = {
            ...
            if (
                (
                    ...
                    or isinstance(field, ZForeignKey)

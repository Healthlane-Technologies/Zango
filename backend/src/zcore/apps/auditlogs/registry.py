...
from zcore.apps.auditlogs.conf import settings
from zcore.apps.auditlogs.signals import accessed
...
class AuditlogModelRegistry:
    ...
    def __init__(
        ...
        from zcore.apps.auditlogs.receivers import (
            log_access,
            log_create,
            log_delete,
            log_update,
    ...
    def _connect_signals(self, model):
        ...
        """
        from zcore.apps.auditlogs.receivers import make_log_m2m_changes

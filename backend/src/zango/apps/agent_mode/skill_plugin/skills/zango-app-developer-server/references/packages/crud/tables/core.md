# Zango CRUD Tables — Core

> Splits of the CRUD tables reference: **core.md** (this file), [advanced.md](advanced.md) (conditional/permission actions, custom queryset, complete example, troubleshooting).

    ...
    def put(self, request, *args, **kwargs):
        ...
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                success, response_content, status = True, "updated", 200  # noqa
            else:
                success, response_content, status = False, serializer.errors, 200  # noqa
        except Exception as e:
            success, response_content, status = False, str(e), 404  # noqa
        return get_api_response(success, response_content, 200)

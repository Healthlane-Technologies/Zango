...
from zelthy.apps.auditlogs.conf import settings
from zelthy.apps.auditlogs.signals import accessed
...
class AuditlogModelRegistry:
    ...
    def __init__(
        ...
        from zelthy.apps.auditlogs.receivers import (
            log_access,
            log_create,
            log_delete,
            log_update,
    ...
    def _connect_signals(self, model):
        ...
        """
        from zelthy.apps.auditlogs.receivers import make_log_m2m_changes

...
from zelthy.core.storage_utils import S3PrivateFileField
...
class TenantModel(TenantMixin, FullAuditMixin):
    ...
    logo = S3PrivateFileField(verbose_name="Logo", null=True, blank=True)
    fav_icon = S3PrivateFileField(verbose_name="FavIcon", null=True, blank=True)

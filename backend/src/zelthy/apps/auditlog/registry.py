...
from zelthy.apps.auditlog.conf import settings
from zelthy.apps.auditlog.signals import accessed
...
class AuditlogModelRegistry:
    ...
    def __init__(
        ...
        from zelthy.apps.auditlog.receivers import (
            log_access,
            log_create,
            log_delete,
            log_update,
    ...
    def _connect_signals(self, model):
        ...
        """
        from zelthy.apps.auditlog.receivers import make_log_m2m_changes

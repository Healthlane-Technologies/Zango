from workspaces.test_tenant.one_to_one.models import Place, Restaurant, OBar, Waiter, ManualPrimaryKey, RelatedModel, MultiModel, UndergroundBar, Target, Pointer, HiddenPointer, ToFieldPointer, School, Director
from django.db.models import Count, Subquery, OuterRef
from zelthy.test_utils.base import BaseTestCase
from django.db import IntegrityError, connection, transaction

class OneToOneTests(BaseTestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.b1 = OBar.objects.create(place=cls.p1, serves_cocktails=False)
    ...
    def test_reverse_object_cache(self):
        ...
        self.assertEqual(self.p1.obar, self.b1)
    ...
    def test_o2o_primary_key_delete(self):
        ...
        self.assertEqual(objs, {"dynamic_models.Pointer": 1})
